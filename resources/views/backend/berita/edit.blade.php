                            ...
                            <form id="form">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label>Konten</label>
                                            <textarea id="content" name="content">{{ $berita->content }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="image" id="image" class="dropify"
                                                data-default-file="{{ asset('storage/thumbnail/' . $berita->image) }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="kategori" id="kategori" class="form-control">
                                                ...
                                                @foreach ($kategori as $row)
                                                    <option value="{{ $row->id }}"
                                                        {{ $row->id == $berita->kategori_id ? 'selected' : '' }}>
                                                        {{ $row->name }}</option>
                                                @endforeach
                                            </select>
